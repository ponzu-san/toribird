...
export default function PasswordInput({ inputClassName, id, ...props }: PasswordInputProps) {
  const [visible, setVisible] = useState(false);

  return (
    <div className="relative">
      <input id={id} type={visible ? "text" : "password"} className={`pr-11 ${inputClassName}`} {...props} />
      <button
        type="button"
