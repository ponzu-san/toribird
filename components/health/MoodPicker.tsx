...
export default function MoodPicker({ value, onChange, disabled }: MoodPickerProps) {
  return (
    <div>
      <p className="mb-1.5 text-sm font-semibold text-muted lg:mb-2">今日の調子</p>
        ...
        {MOOD_OPTIONS.map(option => {
          ...
          return (
            <button
              ...
              className={`flex flex-col items-center gap-1 rounded-2xl border px-2 py-2.5 text-xs font-semibold transition-all lg:py-3 ${
                isActive
